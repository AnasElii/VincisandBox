...
public class App {
    ...
    static void executeQuery(String DB_URL, String Username, String Password, String query, String DB, String message) {
        try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        executeQuery(DB_URL, UserName, Password, "INSERT INTO EMPLOYE " +
                "VALUES(NULL, 'Anas', 'Elouraini', '0610957256', 'Hey Dalia',20000, '1996-01-14', null)", "/gestion_rh",
